...
POSITIONS = {
    ["LOCATION_1"] = {
        ["P1"] = {
            Vector(SCREEN_WIDTH / 4 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2),
            Vector(SCREEN_WIDTH / 4 + CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2),
            Vector(SCREEN_WIDTH / 4 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2 + CARD_HEIGHT),
            Vector(SCREEN_WIDTH / 4 + CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2 + CARD_HEIGHT)
        },
        ["P2"] = {
            Vector(SCREEN_WIDTH / 4 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 - (CARD_HEIGHT/2)),
    ...
    ["LOCATION_2"] = {
        ["P1"] = {
            Vector(SCREEN_WIDTH / 2 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2),
            Vector(SCREEN_WIDTH / 2 + CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2),
            Vector(SCREEN_WIDTH / 2 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2 + CARD_HEIGHT),
            Vector(SCREEN_WIDTH / 2 + CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2 + CARD_HEIGHT)
        },
        ["P2"] = {
            Vector(SCREEN_WIDTH / 2 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 - (CARD_HEIGHT/2)),
    ...
    ["LOCATION_3"] = {
        ["P1"] = {
            Vector(SCREEN_WIDTH * 3 / 4 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2),
            Vector(SCREEN_WIDTH * 3 / 4 + CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2),
            Vector(SCREEN_WIDTH * 3 / 4 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2 + CARD_HEIGHT),
            Vector(SCREEN_WIDTH * 3 / 4 + CARD_WIDTH / 2, SCREEN_HEIGHT / 2 + CARD_HEIGHT/2 + CARD_HEIGHT)
        },
        ["P2"] = {
            Vector(SCREEN_WIDTH * 3 / 4 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 - (CARD_HEIGHT/2)),
